...
#[openapi(
    ...
    paths(
        ...
        crate::api::books::list_in_progress_books,
        crate::api::books::get_book,
        crate::api::books::search_book_metadata,
        crate::api::books::apply_book_metadata,
        ...
        crate::api::memory::ingest_memory_chunk,
        crate::api::memory::delete_memory_chunk,
    ...
    components(schemas(
        ...
        crate::metadata::MetadataCandidate,
        crate::api::books::ApplyMetadataBody,
        ...
        crate::api::memory::IngestMemoryChunkRequest,
        crate::api::memory::IngestMemoryChunkResponse,
    ...
    tags(
        ...
        (name = "memory", description = "Merlin episodic and factual memory chunks"),
