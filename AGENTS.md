...
Register once: `Codex mcp add xcalibre-server-dev node tools/mcp_server.js`
...
Register with Codex:
`Codex mcp add xcalibre-server-library ./target/release/xs-mcp --env CONFIG_PATH=./config.toml`
