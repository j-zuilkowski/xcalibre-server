      ...
      <section className="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-5">
        ...
        {backupCodes ? (
          <div className="mt-5 rounded-2xl border border-amber-500/30 bg-amber-500/10 p-4">
            <p className="font-semibold text-amber-100">Save these backup codes. They will not be shown again.</p>
            <div className="mt-4 grid gap-2 sm:grid-cols-2">
              {backupCodes.map((code) => (
                <div key={code} className="flex items-center justify-between gap-3 rounded-xl border border-zinc-700 bg-zinc-950 px-3 py-2">
          ...
          <div className="mt-5 grid gap-5 lg:grid-cols-[220px_1fr]">
            ...
            <div className="space-y-4">
              <div className="rounded-2xl border border-zinc-700 bg-zinc-950 p-4">
                ...
                <p className="mt-2 break-all font-mono text-sm text-zinc-100">{setupData.secret_base32}</p>
              </div>
      ...
      {disableOpen ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-zinc-950/80 p-4">
          <div className="w-full max-w-md rounded-2xl border border-zinc-700 bg-zinc-950 p-5 shadow-2xl">
            ...
            <p className="mt-2 text-sm text-zinc-400">Enter your current password to confirm this change.</p>
            <input
              type="password"
